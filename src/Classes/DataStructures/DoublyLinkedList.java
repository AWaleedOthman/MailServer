...
public class DoublyLinkedList implements ILinkedList {
	 ...
	 * */
	private dListNode partition (dListNode position, dListNode start, dListNode end, Comparator cmp) {
	 ...
	 * */
	private class ForwardListIterator implements Iterator {
	 ...
	 * */
	public Iterator iterator(boolean forward) {
	    	if (forward) {
